...
//Verificanod se o usuario é administrador
const checkAdmin = (req, res, next) =>
{
    ...
    {
        //se estiver logado e nao for administrador boqueia o acesso
        return res.status(403).send('Acesso negado: apanas administradores podem cadastrar exemplares')
    }
...
//Rota para inserir informações dos exemplares
server.post('/cadastrar2', checkAdmin, async (req, res) =>
{
    ...
    try 
    {
        ...
        console.log('Exemplar cadastrado com sucesso!')
        res.redirect('/index.html')
    } 
    catch (error) 
    {
        console.error('Erro em cadastrar as infomações do exemplar: ', error);
